...
const Nav = () => {
  ...
  return (
    <nav className="relative mb-5 flex items-center">
      <div className="absolute top-0 bottom-0 right-0 bg-gradient-to-l from-[#0c2037] h-10 w-3/12  md:w-1/12 z-10 flex justify-end items-center">
        <BsChevronRight className="lg:invisible text-2xl" />
      </div>
      <div className="absolute top-0  bottom-0 left-0 bg-gradient-to-r from-[#0c2037] h-10 w-3/12 md:w-1/12 lg:invisible z-10 flex items-center  ">
